...
import { Header, JobDetail, JobListing, About, Contact, HomePage, PostJob, ApplyJobs, Footer, Login, Register, Profile, ForgotPassword } from "./View/Component/index"
      ...
      <Col>
        <Row>
          <Routes>
            ...
            <Route path="/fgp" element={<ForgotPassword />} />
